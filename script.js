document.addEventListener("DOMContentLoaded", function () {
    const borrowedBooks = [
        ...
        { title: "Web Technology: Theory and Practice",Author:"Akashi Kumar" , IssueDate: "01/02/2024", borrowedDate: "01/01/2023", fine:"0.00 rs/-" },
        
        { title: "Pattern Recognition and Machine Learning",Author:"Christopher Bishop", IssueDate: "01/04/2024", borrowedDate: "01/01/2023", fine: "0.00 rs/-" },
        
        { title: "Basic Computer Architecture",Author:"Smruti R. Sarangi", IssueDate: "01/04/2024", borrowedDate: "01/01/2023", fine: "0.00 rs/-" },
    ...
    borrowedBooks.forEach(book => {
        ...
        row.insertCell(3).textContent = book.borrowedDate;
        row.insertCell(4).textContent = book.fine;
    });
